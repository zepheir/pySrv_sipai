...
class ZhyDB():
    ...
    def __init__(self, ip='127.0.0.1', port=27017):
        ...
        if DEBUG: print " ==> ZhyDB Initialization"
        ...
        if DEBUG and self.db:
            ...
            print dbgIDF+'zhydb.refreshTime: %.2f'%(float(self.refreshTime))
...
def Test():
    ...
    # test functions
    # zhydb.collectionNames()
    # zhydb.readSipaiMods()
    # zhydb.readSdsMods()
    # zhydb.readValues(re.compile('^.*2$'))
    # zhydb.updateValuesInHistory()

    # print "-----------------------------------"
    # print zhydb.setupSipaiResults()
    # print zhydb.updateSipaiResults(
    #             ip='130.139.200.50',
    #             port="6020",
    #             addr='40',
    ...
    # print zhydb.readSipaiResult(
    #             ip='130.139.200.50',
    #             port="6020",
    #             addr='40',
    #     )

    # print zhydb.db.vars.update({},
    #     {
    #     '$set':{
    #     # 'storeOn':True,
    #     # 'go_value':0
    ...
    print zhydb.updateTempRepeaterResult(
        ip='130.139.200.48',
        port= '10001',
        addr= '000000000108',
        value='0010000'
...
#     print 'Vars Class:', zhydb.varClass
#     rexp1 = re.compile('^wS[^H].*[^A]$')
# #    rexp2 = re.compile('RP')
#     tm = zhydb.readVars(contxt={'Name':rexp1})
#     for t in tm:
# #        t['Rate'] = 1
#         print 'property real %s_b: %0.2f//%s' % (t['Name'], t['Value'] * t['Rate'] / 1000, t['Comment'])
# #        t['StoreON'] = False
# #        zhydb.db.Vars.save(t)
# #    zhydb.setVarsStore(True, tm)
# #    zhydb.renameVarsField(oldname='VarType', newname='VarClass')
# #    zhydb.setVarsClass()
# #    zhydb.setVarsAddr()
# #    zhydb.setElecMeterRatio()
# #    zhydb.setElecMeterType()
# #    zhydb.setElecMeterAddr()
# #    zhydb.setElecMeterComment()
# #    zhydb.removeElecMeterField(fieldname='AMP')
# #    zhydb.removeSipaiModsField(fieldname='DATACODE')
# #    sss = zhydb.db.Vars.find({}, {'VarClass':1})
# #    zhydb.db.ElecMeters.remove({"MODTYPE":{'$ne':None}})
# #    zhydb.renameElecMeterField(oldname='ADDRESS', newname='ADDRESS')
# #    zhydb.propertylist()
